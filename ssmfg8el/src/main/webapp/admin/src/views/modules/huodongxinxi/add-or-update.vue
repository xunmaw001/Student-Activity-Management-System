<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="可报人数" prop="kebaorenshu">
          <el-input v-model="ruleForm.kebaorenshu" 
              placeholder="可报人数" clearable  :readonly="ro.kebaorenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="可报人数" prop="kebaorenshu">
              <el-input v-model="ruleForm.kebaorenshu" 
                placeholder="可报人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.huodongneirong = this.ruleForm.huodongneirong.replace(reg,'../../../ssmfg8el/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
